	...
	<ul>
		<?php if($current_page == "product_editor"){?>
			...
			<a href="product_detail.php?id=<?php echo $_GET['parent'];?>">
				<li class="navi-bar"><span class="icon"><i class="fa fa-angle-left"></i></span><span class="caption">เพิ่มสินค้าย่อย</span></li>
			</a>
			<?php }else if(!empty($_GET['id'])){?>
			<a href="product_detail.php?id=<?php echo $_GET['id'];?>">
				<li class="navi-bar"><span class="icon"><i class="fa fa-angle-left"></i></span><span class="caption">แก้ไขสินค้า</span></li>
			</a>
			<?php }else{?>
			<a href="product.php">
				<li class="navi-bar"><span class="icon"><i class="fa fa-angle-left"></i></span><span class="caption">เพิ่มสินค้าใหม่</span></li>
			</a>
			<?php }?>
		<?php }else if($current_page == "bank_editor"){?>
			<?php if(empty($bank->id)){?>
			<a href="bank.php">
				<li class="navi-bar"><span class="icon"><i class="fa fa-angle-left"></i></span><span class="caption">เพิ่มบัญชีธนาคารใหม่</span></li>
			</a>
			<?php }else{?>
			<a href="bank.php">
				<li class="navi-bar"><span class="icon"><i class="fa fa-angle-left"></i></span><span class="caption">แก้ไขบัญชีธนาคาร</span></li>
			</a>
			<?php }?>
		<?php }else if($current_page == "product_quantity"){?>
			<?php if($_GET['action'] == "import"){?>
			<a href="product.php">
				<li class="navi-bar"><span class="icon"><i class="fa fa-angle-left"></i></span><span class="caption">นำเข้าสินค้า</span></li>
			</a>
			<?php }else if($_GET['action'] == "export"){?>
			<a href="product.php">
				<li class="navi-bar"><span class="icon"><i class="fa fa-angle-left"></i></span><span class="caption">โอนสินค้าออก</span></li>
			</a>
			<?php }?>
		<?php }else if($current_page == "order_detail"){?>
			<a href="index.php">
				<li class="navi-bar"><span class="icon"><i class="fa fa-angle-left"></i></span><span class="caption">รายการสั่งซื้อที่ <?php echo $order->id;?></span></li>
			</a>
		<?php }else{?>
			<a href="index.php">
