...
// Permission checking and redirect to permission-error page.
if(!MEMBER_ONLINE || MEMBER_ID != $user->id || $user->type != "administrator"){
	header("Location: permission-error.php");
	die();
}
?>