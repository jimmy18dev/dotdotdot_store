...
<div class="items-in-order" id="items-in-order-<?php echo $var['product_id'];?>">
	...
	<div class="items-in-order-detail">
		...
		<p class="detail-description"><?php echo number_format($var['product_price']);?> บาท <?php if($order_status == "Shopping"){?><span class="remove-btn" onclick="javascript:RemoveItemInOrder(<?php echo $var['order_id'];?>,<?php echo $var['product_id'];?>);">ลบรายการ</span><?php }?></p>
	</div>
